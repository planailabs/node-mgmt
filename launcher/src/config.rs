...
pub const WEBUI_PORT: u16 = 8080;

pub fn ollama_health_url() -> String {
    format!("http://{OLLAMA_HOST}:{OLLAMA_PORT}/api/version")
}
pub fn webui_health_url() -> String {
    format!("http://{WEBUI_HOST}:{WEBUI_PORT}/health")
}
#[allow(dead_code)] // used by the SPA-serving phase
